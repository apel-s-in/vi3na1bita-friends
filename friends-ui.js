...
import { getPlayableGames } from './games-registry.js?v=9.1.5';
import { createFriendsModalAdapter } from './modal-adapter.js?v=9.1.5';
import { openTextChatModal } from './chat-text-ui.js?v=9.1.5';
import { openVoiceCallUi } from './voice-call-ui.js?v=9.1.5';
