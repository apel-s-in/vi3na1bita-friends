...
import { getPlayableGames } from './games-registry.js?v=8.9.9';
import { createFriendsModalAdapter } from './modal-adapter.js?v=8.9.9';
import { openTextChatModal } from './chat-text-ui.js?v=8.9.9';
import { openVoiceCallUi } from './voice-call-ui.js?v=8.9.9';
