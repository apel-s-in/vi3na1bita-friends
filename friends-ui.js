...
import { getPlayableGames } from './games-registry.js?v=8.9.2';
import { openTextChatModal } from './chat-text-ui.js?v=8.9.2';
import { openVoiceCallUi } from './voice-call-ui.js?v=8.9.2';
